  ...
  return (
    <Link
      ...
      style={{
        ...
        flexShrink: 0, // prevent nav items from shrinking
      }}
      onMouseEnter={(e) => {
        if (!active) {
...
export default function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside style={{
      width:         "100%", // fill the fixed sidebar-wrapper
      height:        "100dvh",
      background:    "var(--bg-surface)",
      borderRight:   "1px solid var(--border-subtle)",
      display:       "flex",
      flexDirection: "column",
      // No padding here — handled per-section so scrollable area works correctly
      overflowY:     "hidden", // the inner sections handle their own scroll
    }}>

      {/* ── Top: Logo + close btn (fixed, never scrolls) ── */}
      <div style={{
        padding:        "24px 16px 0",
        flexShrink:     0,
        marginBottom:   24,
      ...
      {/* ── Middle: Nav (scrollable if content overflows) ── */}
      <div style={{
        flex:       1,
        overflowY:  "auto",
        overflowX:  "hidden",
        padding:    "0 16px",
        // Custom scrollbar so it blends in
        scrollbarWidth: "thin",
        ...
        <p style={{
          ...
          textTransform: "uppercase", marginBottom: 8, paddingLeft: 12,
        }}>
          Workspace
        </p>
      ...
      {/* ── Bottom: User profile + sign out (fixed, never scrolls off screen) ── */}
      {user && (
        <div style={{
          flexShrink:   0, // never compress this section
          padding:      "16px 16px 20px",
          borderTop:    "1px solid var(--border-subtle)",
          background:   "var(--bg-surface)", // ensure it stays opaque
        }}>
          <Link href="/settings" style={{ textDecoration: "none" }}>
            ...
            >
              <div style={{
                ...
                justifyContent: "center", flexShrink: 0, fontFamily: "var(--font-display)",
              ...
              <div style={{ overflow: "hidden", flex: 1 }}>
                ...
                <p style={{
                  fontSize: "0.72rem", color: "var(--text-muted)", overflow: "hidden",
